 ...
 *
 * Requer: NEXT_PUBLIC_SUPABASE_URL e SUPABASE_SERVICE_ROLE_KEY ou SUPABASE_SECRET_KEY em .env.local ou .env.production
 */
...
async function main() {
  ...
  console.log('\n══════════════════════════════════════════════')
  console.log('  VERIFICAÇÃO DE MIGRATIONS — ZAIRYX')
  console.log('══════════════════════════════════════════════\n')
