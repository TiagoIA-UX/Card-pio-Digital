...
> = {
  ...
  templates: {
    ...
    description: 'Explore nossos templates disponíveis na página principal',
  },
  error: {
...
export function EmptyState({
  ...
  return (
    ...
    >
      {/* Ícone */}
      <div className="bg-muted text-muted-foreground mb-4 rounded-full p-6">
        {icon || defaultConfig.icon}
      </div>

      {/* Título */}
      <h3 className="text-foreground mb-2 text-lg font-semibold">{title || defaultConfig.title}</h3>
