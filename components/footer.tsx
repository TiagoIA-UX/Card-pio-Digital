        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-muted-foreground">
              Cardápios digitais profissionais para delivery, pizzarias, hamburguerias, bares e negócios alimentícios. WhatsApp, Google Maps integrado e gestão de pedidos.
            </p>
