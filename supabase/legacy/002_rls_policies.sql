...
--
-- Arquivo legado preservado fora da pasta de migrations ativas.
-- Ele referencia o schema multi-tenant original baseado em `tenants`/`users`,
-- que nao corresponde mais ao schema remoto atual.
-- =====================================================
...
-- Plans nao precisa de RLS (publico)
ALTER TABLE plans ENABLE ROW LEVEL SECURITY;

-- =====================================================
-- POLITICAS: plans (Publico - todos podem ler)
-- =====================================================
...
-- Leitura publica do tenant (para cardapio publico)
...
-- Usuarios autenticados veem seu proprio tenant
...
-- Insert e feito via funcao de onboarding (service role)

-- =====================================================
-- POLITICAS: users
-- =====================================================

-- Usuario ve apenas usuarios do seu tenant
...
-- Owner pode gerenciar usuarios do tenant
...
-- Publico pode ver categorias ativas
...
-- Pedidos sao privados do tenant
...
-- Anon pode criar pedidos (checkout publico)
...
-- Nao permite deletar pedidos, apenas cancelar

-- =====================================================
-- POLITICAS: order_items
-- =====================================================
...
-- Insert/Update via funcao (service role)
...
-- Garantir que anon pode acessar tabelas publicas
...
-- Authenticated tem acesso completo as suas tabelas
